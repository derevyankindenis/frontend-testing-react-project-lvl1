...
describe('ExtendedURL tests', () => {
  ...
  test('isGlobal', () => {
    ...
    const url2 = new ExtendedURL('https://site.com/assets/scripts.js', 'https://site.com');

    expect(url2.isGlobal).not.toBeTruthy();

    const url3 = new ExtendedURL('https://cdn2.site.com/blog/assets/style.css', 'https://site.com');
